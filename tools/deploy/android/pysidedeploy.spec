...
;
; NOTE: pyside6-android-deploy parses this with configparser using ';' as the
; ONLY comment prefix -- '#' is treated as content and breaks the parse. Keep
; all comments ';'-prefixed.
;
